...
export default class Homepage extends Component {
	...
	return (
		...
		<div className="hero-text">
		    <img className="louisphoto" src={louislogo} alt="Louis Lefebvre" />
