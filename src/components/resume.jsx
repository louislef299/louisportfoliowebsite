...
export default class Resume extends Component {
	...
	return (
		...
		<h1 className="boldNeed">Resume</h1>
		<h2 className="needyBorder">Education</h2>
		<h3 className="boldNeed">University of Minnesota - Twin Cities</h3>
		<h4>Expected Graduation June 2021</h4>
		<p>B.A. Computer Science</p>
		<h3 className="boldNeed">Edina High School</h3>
		<h4>Sep 2014 - May 2017</h4>
		<p>Honors: AP Scholar, Athlete Scholar, Varsity Captain</p>
		<h2 className="needyBorder">Experience</h2>
		<h3 className="boldNeed">Best Buy - Small Parcel Delivery</h3>
		<h4>Current</h4>
		<ul>
		...
		<h3 className="boldNeed">Rainbow Treecare - Tree Technician</h3>
		...
		<h3 className="boldNeed">Tea House - Server</h3>
		...
		<h3 className="boldNeed">University of Minnesota Classroom Services - Classroom Condition Monitor</h3>
		...
		<h2 className="needyBorder">Relevant Experience Within Field</h2>
